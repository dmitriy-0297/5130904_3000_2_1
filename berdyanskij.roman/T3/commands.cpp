...
void berdyanskij::area(const std::vector< berdyanskij::Polygon >& vector, std::istream& in, std::ostream& out)
{
  std::string arg;
  in >> arg;
  auto accumalateArea_if =
    [](double ac, const berdyanskij::Polygon& poly, long unsigned int mod2, std::size_t vertices) {
...
void berdyanskij::max(const std::vector< berdyanskij::Polygon >& vector, std::istream& in, std::ostream& out)
{
  std::string arg;
  in >> arg;
  if (vector.empty())
...
void berdyanskij::min(const std::vector< berdyanskij::Polygon >& vector, std::istream& in, std::ostream& out)
{
  std::string arg;
  in >> arg;
  if (vector.empty())
...
void berdyanskij::count(const std::vector< berdyanskij::Polygon >& vector, std::istream& in, std::ostream& out)
{
  std::string arg;
  in >> arg;
...
void berdyanskij::inFrame(const std::vector< berdyanskij::Polygon >& vector, std::istream& in, std::ostream& out)
{
  Polygon poly;
  in >> poly;
  if (in.fail() || in.get() != '\n')
...
void berdyanskij::rmecho(std::vector< berdyanskij::Polygon >& vector, std::istream& in, std::ostream& out)
{
  Polygon poly;
  in >> poly;
  if (in.fail() || in.get() != '\n')
...
bool berdyanskij::isUnsignedInt(const std::string& str)
{
